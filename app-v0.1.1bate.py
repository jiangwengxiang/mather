...
class MathTrainerApp:
    ...
    def geometry_calculator(self):
        ...
        geometry_options = [
            ...
            ("棱锥体积", self.calculate_cone_volume),
            ("棱台体积", self.calculate_pyramid_volume),
            ("三角形面积", self.calculate_triangle_area),
        ]
    ...
    def create_input_dialog(self, title, fields, calculate_func):
        ...
        # 聚焦第一个输入框
        dialog.after(100, lambda: entry_new_name.focus_set())
    ...
    def squ_triangel2(self, a, angle):
        """计算三角形面积(两边及夹角)"""
        return 0.5 * a * a * math.sin(math.radians(angle))
